...
<div class="pageContent">
    <div class="panelBar">
        <ul class="toolBar">
            <li>
                <a class="add" href="addContactType.action"  target="navTab" rel="addContactType"><span>添加</span></a>
            </li>
            <li>
                <a title="确实要删除这些记录吗?" target="selectedTodo" rel="entityIds" href="removeContactTypes.action" class="delete"><span>删除</span></a>
            </li>
            <!--<li>
    ...
    <table class="table" width="1100" layoutH="138">
        ...
        <tbody>
        <c:forEach items="${pager.pageRecords}" var="contactType" varStatus="s">
            <tr target="sid_user" rel="1">
                <td>
                    <input name="entityIds" value="${contactType.typeId }" type="checkbox">
                </td>
                <td>
                         ${contactType.typeName }
                </td>
                <td>
                    <a title="删除" target="ajaxTodo" href="removeContactType.action?contactTypeid=${contactType.typeId }" class="btnDel">删除</a>
                    <a title="编辑" target="navTab" href="editContactType.action?contactTypeid=${contactType.typeId }" class="btnEdit" rel="editContactType">编辑</a>
                </td>
            </tr>
            </c:forEach>
        </tbody>
