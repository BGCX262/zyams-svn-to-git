...
<form id="pagerForm" method="post" action="#rel#">
    <input type="hidden" name="pageNum" value="1" /><input type="hidden" name="numPerPage" value="${model.numPerPage}" />
</form>
<div class="pageHeader">
    <form rel="pagerForm" onsubmit="return navTabSearch(this);" action="listRoles.action" method="post">
    </form>
</div>
<div class="pageContent">
    <div class="panelBar">
        <ul class="toolBar">
            <li>
                <a class="add" href="addRole.action" target="navTab"><span>添加</span></a>
            </li>
            <li>
                <a title="确实要删除这些记录吗?" target="selectedTodo" rel="entityIds" href="removeRoles.action" class="delete"><span>删除</span></a>
            </li>
            <!--<li>
            ...
            <li>
                <a class="edit" href="editRole.action?roleId={sid_user}" target="navTab" warn="请选择一条记录"><span>修改</span></a>
            </li>-->
            <li class="line">
                line
            </li>
    ...
    <table class="table" width="1100" layoutH="138">
        ...
        <tbody>
         <c:forEach items="${pager.pageRecords}" var="role" >
            <tr target="sid_user" rel="1">
                <td>
                    <input name="entityIds" value="${role.roleId}" type="checkbox">
                </td>
                <td>
                    ${role.roleName }
                </td>
                <td>
                    <a title="删除" target="ajaxTodo" href="removeRole.action?roleId=${role.roleId }" class="btnDel">删除</a>
                    <a title="编辑" target="navTab" href="editRole.action?roleId=${role.roleId }" class="btnEdit">编辑</a>
                </td>
            </tr>
            </c:forEach>
        </tbody>
