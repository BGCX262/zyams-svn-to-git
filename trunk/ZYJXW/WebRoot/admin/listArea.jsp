...
<div class="pageHeader">
    <form rel="pagerForm" onsubmit="return navTabSearch(this);" action="listAreas.action" method="post">
    <input type="hidden" name="typeId" value="${dictionarys.code}"/>
        <div class="searchBar">
...
<div class="pageContent">
    <div class="panelBar">
        <ul class="toolBar">
            <li>
                <a class="add" href="addArea.action"  target="navTab"><span>添加</span></a>
            </li>
            <li>
                <a title="确实要删除这些记录吗?" target="selectedTodo" rel="entityIds" href="removeAreas.action?dictid=107" class="delete"><span>删除</span></a>
            </li>
            <!--<li>
    ...
    <table class="table" width="1100" layoutH="138">
        ...
        <c:forEach items="${pager.pageRecords}" var="dictionary" varStatus="s">
            <tr target="sid_user" rel="1">
                ...
                <td>
                    <a title="删除" target="ajaxTodo" href="removeArea.action?code=${dictionary.code }&dictid=107" class="btnDel">删除</a>
                    <a title="编辑" target="navTab" href="editArea.action?code=${dictionary.code }&dictid=107" class="btnEdit">编辑</a>
                </td>
            </tr>
            </c:forEach>
        </tbody>
